...
import com.example.gender_inclusiveperiodtracker.data.EpisodeDao
import com.example.gender_inclusiveperiodtracker.utilities.TimeUtils
...
class EpisodeRepository private constructor(private val episodeDao: EpisodeDao) {
    ...
    private fun updateCycle(recentEpisode: Episode) {
